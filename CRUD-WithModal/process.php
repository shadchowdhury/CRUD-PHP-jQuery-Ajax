...
function show()
{
	...
	$Output = '<table class="table" id="myTable"  border="1">
				<thead>
					<tr>
						<th>Full Name</th>
						<th>User Name</th>
	...
	while ($data = $result->fetch_assoc()) {
		$Output .= '<tr>
						...
						<td>' . $data["status"] . '</td>
						<td>
							<button class="btn btn-info btn-sm" id="btnEdit" data-bs-toggle="modal" data-bs-target="#editmodal" value="' . $data["id"] . '">Edit</button>
							<button class="btn btn-danger btn-sm" id="btnDelete" data-bs-toggle="modal" data-bs-target="#delete" value="' . $data["id"] . '">Delete</button>
						</td>
					</tr>
			';
	}
